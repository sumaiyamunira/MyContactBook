...
public class DBHelper extends SQLiteOpenHelper {
	...
	public ArrayList getAllCotacts(int noOfDisplay) {
		// hp = new HashMap();
		SQLiteDatabase db = this.getReadableDatabase();
		int totalRow = (int) DatabaseUtils.queryNumEntries(db, CONTACTS_TABLE_NAME);
		Log.e("no of display", ""+totalRow);
		if(noOfDisplay < totalRow) {
			array_list = new ArrayList();
			Cursor res = db.rawQuery("select * from contacts LIMIT "+ noOfDisplay, null);
			res.moveToFirst();
